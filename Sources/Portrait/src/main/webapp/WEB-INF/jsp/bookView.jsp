...
<head>
		...
		<title>Portrait Photo Album Showcase</title>
		<link rel="stylesheet" type="text/css" href="css/book/default.css" />
		<link rel="stylesheet" type="text/css" href="css/book/component2.css" />
	...
	<body>
		<div class="container">	
			...
			<header class="clearfix">
				<h1>Portrait Photo Album Showcase</h1>	
			</header>
			<div class="main">
						...
						<div class="bk-book book-1">
							...
							<div class="bk-page">
								...
								<div class="bk-content">
									<p><img src="images/2.jpg" width="100%"></p>
								</div>
								<div class="bk-content">
									<p><img src="images/1.jpg" width="100%"></p>
								</div>
								<div class="bk-content">
		...
		<script src="js/book/books2.js"></script>
		<script>
			$(function() {
