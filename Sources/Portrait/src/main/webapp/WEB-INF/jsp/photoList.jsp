...
<script type="text/javascript">
	...
	<script type="text/javascript">
		function loading_st() {
			...
			layer_str = "<div id='loading_layer' style='position:absolute; background-color:; font-size:12px; left:"+ct_left+"px; top:"+ct_top+"px; width:400px; height:; padding:50px; text-align:center; font-family:'nanum gothic'; vertical-align:middle; z-index:1000; font-size: 3em;'>Loading...</div>"
...
<div id="loadingDiv" style="display: none;">
		...
		<div id='viewModeYo'>
			<div id="sidebar-wrapper" style="position: fixed; top: 0;">
				<!-- <form class="form-updatePhotos" name="form-updatePhotos"
					method="post"> -->
				<ul class="sidebar-nav" style="font-family: 'Nanum Gothic'; letter-spacing: 0px;">
					...
					<li><a href="#"><label for="albumTitle">Album
							...
							style="margin-left: 30px; font-family: 'Nanum Gothic'; letter-spacing: -1px;">
					</a></label></li>

					<li><a href="#"><label for="time">Time</label> <input
							type='text' id='pTime' name='time' class="span2 search-query"
							style="margin-left: 30px;  font-family: 'Nanum Gothic'; letter-spacing: -1px;"> </a></li>

					<li><a href="#"><label for="geoTag">GeoTag</label> <input
							type='text' id='pGeoTag' name='geoTag' class="span2 search-query"
							disabled="disabled" style="margin-left: 30px;  font-family: 'Nanum Gothic'; letter-spacing: -1px;"> </a></li>

					<li><a href="#"><label for="model">Camera Model<br>
							<input type='text' id='pModel' name='model'
								class="span2 search-query" disabled="disabled"
								style="margin-left: 30px;  font-family: 'Nanum Gothic'; letter-spacing: -1px;">
						</label></a></li>

					<li id='tagLi0' style="display:"><a href="#"><label
							for="tags">Tags<br>
							<input type="text" id='pTags0' class="form-control" name="tags"
								value="" placeholder="Type something and hit enter"
								style="margin-left: 30px;  font-family: 'Nanum Gothic'; letter-spacing: -1px;" /></label></a></li>
					<c:forEach items="${requestScope.photoList }" var="photo"
						varStatus="status">
						<li id='tagLi${status.count }' style="display: none;"><a
							href="#"><label for="tags">Tags<br>
								<input type="text" id='pTags${status.count }'
									class="form-control" name="tags" value="${photo.tagText }"
									placeholder="Type something and hit enter"
									style="margin-left: 30px;  font-family: 'Nanum Gothic'; letter-spacing: -1px;" /></label></a></li>
					</c:forEach>

					<li id='peopleLi0' style="display:"><a href="#"><label
							for="people">People<br>
							<input type="text" id='pPeople0' class="form-control2"
								name="people" value=""
								placeholder="Type people name and hit enter"
								style="margin-left: 30px;" /></label></a></li>
					<c:forEach items="${requestScope.photoList }" var="photo"
						varStatus="status">
						<li id='peopleLi${status.count }' style="display: none;"><a
							href="#"><label for="people">People<br>
								<input type="text" id='pPeople${status.count }'
									class="form-control2" name="people"
									value="${photo.peopleText }"
									placeholder="Type people name and hit enter"
									style="margin-left: 30px;" /></label></a></li>
					</c:forEach>
									...
									<c:forEach items="${requestScope.photoList }" var="photo"
										...
										<c:forEach items="${photo.album}" var="a" varStatus="astatus">
											<a href="#"><img src="${photo.photoUrl}?width='210px'"
												...
												data-index="${status.count }" alt="image01" /><span>${photo.photoTitle}</span></a>
										</c:forEach>
									</c:forEach>
		...
		<div id="selectModeYo">
			<div id="sidebar-wrapper" style="top: auto;">
				<ul class="sidebar-nav">
					<li class="sidebar-brand"><a href="#"> Photo Informations
					</a> <input type="hidden" id="tagList" value="${requestScope.tagList }">
						<input type="hidden" id="peopleList"
						value="${requestScope.peopleList }"></li>
					<form class="form_updatePhotos" name="form_updatePhotos" id="form_updatePhotos"
						method="post" action="updateMulti.do">
						<label for="albumTitle"><li><a href="#">AlbumTitle</br>
							...
							for="services"><li><a href="#">Services<input
									...
									style="margin-left: 30px"></a></li></label> <li id='tagLi0' style="display: "><a href="#"><label for="tags">Tags<br><input
									type="text" id='pTags' class="form-control" name="tags" value=""
							...
							<li id='peopleLi0' style="display: "><a href="#"><label for="people">People<br><input
									type="text" id='pPeople' class="form-control2" name="people" value=""
							placeholder="Type people name and hit enter" style="margin-left: 30px;" /></label></a></li>
							 <label for="comments"><li><a
								href="#">Description</br> <input name='comments'
						...
						<div align="right" style="margin-right: 35px; margin-top: -50px;">
							<button type="submit" class="btn" onclick="javascript:updateMulti()">update</button>
						</div>
					</form>
					...
					<li>
						<form class="form_addEvent" name="form_addEvent" method="post"
							...
							<a href="#">Event Name</br> <input name='eventName'
								class="span2 search-query" style="margin-left: 30px"></a> <a
								href="#">Event Date</br> <input name='eventDate' id="datepicker"
								class="span2 search-query" style="margin-left: 30px"></a> <a
								href="#">Event Description</br>
							<input name='eventDesc' class="span2 search-query"
					...
					<li style="margin-top: -100px; margin-left: 12%">
						<form class="form_deletePhoto" name="form_deletePhoto"
							...
							<input type="hidden" value="${requestScope.albumId}" id="albumId"
								name="albumId">
							<button type="submit" class="btn"
									...
									<c:forEach items="${requestScope.photoList}" var="photo"
										...
										<a href="#"> <input type="checkbox" class="checkMan"
											...
											for="${photo.photoId}"> <img
												...
												data-largesrc="${photo.photoUrl }?imgmax=2048" alt="image01" /><span></span></label></a>
	...
	<script>
		...
		function updateMulti() {
			...
			for (i = 0; i < chkFirList2.length; i++) {
				if (chkFirList2[i].checked) {
					arrFir2.push(chkFirList2[i].value);
					console.log(chkFirList2[i].value);
				}
			}
			
			document.getElementById('form_updatePhotos').action = "updateMulti.do?arrFir2="
					+ arrFir2;
	...
	<link href="./docs-assets/css/pygments-manni.css" type="text/css"
		rel="stylesheet">
	<link href="./docs-assets/css/docs.css" type="text/css"
		rel="stylesheet">
