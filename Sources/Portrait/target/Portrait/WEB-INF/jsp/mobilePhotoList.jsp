	...
	<div class="container">
		...
		<div class="main">
			...
			<h1 style="font-family:'nanum gothic'; letter-spacing: -1px;">
				Search Result <small style="color: #F96E5B">from Portrait</small><span>
${requestScope.albumTitle}				
			...
			<c:forEach items="${requestScope.photoList }" var="photo" varStatus="status">
				<c:forEach items="${photo.album}" var="a" varStatus="astatus">
					<li>
						<div data-alt="img03" data-description="<h3>${a.albumTitle}</h3>"
							data-max-width="1800" data-max-height="1350">
							<div data-src="${photo.photoUrl}" data-min-width="1300"></div>
							<div data-src="${photo.photoUrl}" data-min-width="1000"></div>
							<div data-src="${photo.photoUrl}" data-min-width="700"></div>
							<div data-src="${photo.photoUrl}" data-min-width="300"></div>
							<div data-src="${photo.photoUrl}" data-min-width="200"></div>
							<div data-src="${photo.photoUrl}" data-min-width="140"></div>
							<div data-src="${photo.photoUrl}"></div>
							<noscript>
								<img src="${photo.photoUrl}" alt="img03" />
							</noscript>
						</div>
					</li>
				</c:forEach>
