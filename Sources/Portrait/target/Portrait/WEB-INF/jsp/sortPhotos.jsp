...
<!-- ----------------------------select mode----------------------------- -->
		...
		<div id="sidebar-wrapper1" style="top: auto;">
			<ul class="sidebar-nav">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<c:choose>
								 ...
								 <c:when test="${requestScope.boundary == 24 }">
									1일 단위로 모아보기
								 </c:when>
				...
				<li>
					<form class="form_addAlbum" name="form_addAlbum" method="post" action="addAlbum.do">
							<a href="#">Album Title</br> <input name='albumTitle'
								class="span2 search-query" style="margin-left: 30px"></a> 
							<div align="right" style="margin-right: 35px">
								<button type="submit" class="btn"
									onclick="javascript:addAlbum()">Add Album</button>
							</div>
					</form>
				</li>
			</ul>
	...
	<script>
 	...
 	$(".lightbox span.zoom a").ClassyBox({
		...
		function addAlbum() {
			...
			document.form_addAlbum.action = "addAlbum.do?arrFir=" + arrFir;
		}
